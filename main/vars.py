...
class Var(object):
    ...
    API_HASH = str(environ.get("API_HASH","1459910748"))
    BOT_TOKEN = str(environ.get("BOT_TOKEN","5478011283:AAF8wL2dZIeh2p7j-ocz5TtydqowKtRQZ90"))
    ...
    FQDN = (
        ...
        if not ON_HEROKU or environ.get("FQDN", 13.232.68.159)
